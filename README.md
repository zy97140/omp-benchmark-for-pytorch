...
##### Intel-Pytorch 
The installation instruction is mainly modified from official pytorch. You should be care of the branch is __dev-omp2__._
...
![](benchmark-charts/contiguous_copy.png "copy contiguous tensor")
